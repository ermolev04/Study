...
public class MyScannerRev {
    public static final int DEF_SIZE  = 1;
    public static final int DEF_ARR_SIZE  = 100;
    final Reader reader;
    ...
    public MyScannerRev() throws IOException{
    ...
    public MyScannerRev(String file, String code) throws IOException, FileNotFoundException{
        this.reader = new BufferedReader(new InputStreamReader(
    ...
    ;
    public MyScannerRev(String string) throws IOException{
        this.reader = new BufferedReader(new InputStreamReader(
